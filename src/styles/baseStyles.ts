...
export const baseLinkStyles: SxProps<Theme> = {
  color: THEME.colors.primary.main,
  textDecoration: 'none',
  '&:hover': {
...
// Estilos base para containers
export const baseContainerStyles: SxProps<Theme> = {
  display: 'flex',
  flexDirection: 'column',
  alignItems: 'center',
...
// Estilos base para cards/papers
export const basePaperStyles: SxProps<Theme> = {
  p: { xs: 2, sm: 4 },
  borderRadius: THEME.borderRadius.lg,
